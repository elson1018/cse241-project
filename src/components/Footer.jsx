      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-20 pb-16 border-b border-pink-500/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                {[
                    { name: "Sarah Jenkins", role: "CEO & Founder", initials: "SJ", color: "from-pink-500 to-red-500" },
                    { name: "Elson Ooi", role: "Head of Tech", initials: "EO", color: "from-blue-500 to-indigo-500" },
                    { name: "Priya Sharma", role: "Community Lead", initials: "PS", color: "from-purple-500 to-violet-500" },
                    { name: "Mei Ling", role: "Product Design", initials: "ML", color: "from-green-400 to-emerald-600" }
                ].map((member, i) => (
                    <div key={i} className="group flex flex-col items-center p-6 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 hover:scale-105 transition-all duration-300 cursor-pointer">
                        <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${member.color} flex items-center justify-center font-bold text-white text-2xl mb-4 shadow-lg group-hover:rotate-6 transition-transform`}>
                            {member.initials}
                        </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-pink-100/60 text-sm">
              <li className="block">
                ...
                123 Empowerment Avenue,<br />Tech City, TC 90210
              </li>
